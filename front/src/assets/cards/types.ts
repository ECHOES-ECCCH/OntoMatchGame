...
export const types: OntoType[] = [
  ...
  { id: 'D1', branch: ['conceptual'] },
  { id: 'D2', branch: ['temporal'] },
  { id: 'D3', branch: ['temporal'] },
  { id: 'D7', branch: ['temporal'] },
  { id: 'D8', branch: ['physical'] },
  { id: 'D9', branch: ['dimension', 'conceptual'] },
  { id: 'D10', branch: ['temporal'] },
  { id: 'D11', branch: ['temporal'] },
  { id: 'D12', branch: ['temporal'] },
  { id: 'D13', branch: ['physical'] },
  { id: 'D14', branch: ['conceptual'] },
  { id: 'D29', branch: ['conceptual'] },
  { id: 'D30', branch: ['temporal'] },
  { id: 'D35', branch: ['conceptual', 'physical'] },
]
